...
namespace SocialDotNet.Infrastructure.Migrations
{
    ...
    [Migration("20240602011311_ChatsFix")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialDotNet.Domain.Chat.Chat", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("SocialDotNet.Domain.Chat.Chat", b =>
                {
                    b.OwnsMany("SocialDotNet.Domain.Chat.Entities.ChatMember", "ChatMembers", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
                    ...
                    b.OwnsMany("SocialDotNet.Domain.Chat.Entities.Message", "Messages", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SocialDotNet.Domain.User.User", b =>
                {
                    b.OwnsMany("SocialDotNet.Domain.User.Entities.FriendRequest", "FriendRequests", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
                    ...
                    b.OwnsMany("SocialDotNet.Domain.User.Entities.Friendship", "Friendships", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
